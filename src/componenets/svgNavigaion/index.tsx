...
export const SvgNavigation: React.FC<SvgNavigation> = ({ }) => {
    return (
        <>
        
            <svg  width="37" height="527" viewBox="-0 00 37 527" fill="none">
                <path d="M 19.3078 2.0002 
                l -15.5619 12.8139 l 0 20 
                l 15.5619 12.8139 l 0 207 
                l 15.5619  12.8139  l 0 20
                l -15.5619  12.8139   l 0.000 61 
                l -15.5619  12.8139  l -0 20 
                l 15.5619  12.8139  l -0.000 61
                 l 15.5619  12.8139  l 0 20
                 l -15.5619  12.8139 " stroke="white" strokeWidth="4.80588" />


                <svg x="2" y="0" width="33" height="47" viewBox="0 0 33 47" fill="none"  >
                ...
                <svg x="2" y="253" width="33" height="47" viewBox="0 0 33 47" fill="none" >
                    <g filter="url(#filter0_b_0_427)">
                        <path d="m 16.6866 0.7983 l 15.192 12.6828 l 0.6614 19.6582 l -15.8534 13.3168 l -15.8807 -12.6827 v -20.2923 l 15.8807 -12.6828 z" fill="white" fillOpacity="0.27" />
                    </g>
                    <defs>
                ...
                <svg x="2" y="360" width="33" height="47" viewBox="0 0 33 47" fill="none" 
                >
                    <g filter="url(#filter0_b_0_427)">
                        <path d="m 16.6866 0.7983 l 15.192 12.6828 l 0.6614 19.6582 l -15.8534 13.3168 l -15.8807 -12.6827 v -20.2923 l 15.8807 -12.6828 z" fill="white" fillOpacity="0.27" />
                    </g>
                ...
                <svg x="2" y="467" width="33" height="47" viewBox="0 0 33 47" fill="none">
                    <g filter="url(#filter0_b_0_427)">
                        <path d="m 16.6866 0.7983 l 15.192 12.6828 l 0.6614 19.6582 l -15.8534 13.3168 l -15.8807 -12.6827 v -20.2923 l 15.8807 -12.6828 z" fill="white" fillOpacity="0.27" />
                    </g>
                    <defs>
                ...
                <svg x="0" y="0"
                    width="33" height="43" viewBox="0 0 33 43" fill="none">
                ...
                <svg x="-2" y="254" width="32" height="43" viewBox="0 0 32 43" fill="none">
                    ...
                    <svg x="0" y="360" width="32" height="43" viewBox="0 0 32 43" fill="none">
                        <g filter="url(#filter0_d_0_433)">
                            <path d="m 19.7657 9.142 l 9.7158 9.2429 v 10.3302 l -9.7158 10.3302 l -9.8572 -10.3302 v -10.3302 l 9.8572 -9.2429 z" fill="white" />
                        </g>
                        <defs>
                    ...
                    <svg x="-2" y="467" width="32" height="43" viewBox="0 0 32 43" fill="none">
                        <g filter="url(#filter0_d_0_433)">
                            <path d="m 19.7657 9.142 l 9.7158 9.2429 v 10.3302 l -9.7158 10.3302 l -9.8572 -10.3302 v -10.3302 l 9.8572 -9.2429 z" fill="white" />
                        </g>
                        <defs>
