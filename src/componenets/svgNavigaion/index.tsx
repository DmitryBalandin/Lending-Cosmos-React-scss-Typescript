    ...
    return (
        <div onClick={handler}>
            ...
            <svg width="37" height={allLineHight} viewBox={`-0 00 37 ${allLineHight}`} fill="none">
                ...
                {locationDiamond.map((value) => {
                    return <svg  x="2" y={value} width="33" height="47" viewBox="0 0 33 47" fill="none"  >
                ...
                {locationDiamond.map((value, index) => {
                    ...
                    if (index === activityDiamond) {
                        return (
                            ...
                            <svg id={`${index}`} className="diamond" data-id={index} x={correctinX} y={value}
                        ...
                        <svg id={`${index}`} className="diamond" data-id={index} x={correctinX} y={value} width="32" height="43" viewBox="0 0 32 43" fill="none">
